...
class CovidRepoImpl @Inject constructor(private val covidRemoteDataSourceImpl: CovidCasesRemoteDataSource , private val healthyLocalDataSourceImpl: HealthyLocalDataSource):
    CovidRepo {
    ...
    override suspend fun readWeightData(interval: Long): List<VitalsRecord> {
        return healthyLocalDataSourceImpl.readWeightData(interval)
    }
    ...
    override suspend fun readBloodPressureData(interval: Long): List<VitalsRecord> {
       return healthyLocalDataSourceImpl.readBloodPressureData(interval)
    }

    override suspend fun readRespiratoryRateData(interval: Long): List<VitalsRecord> {
       return healthyLocalDataSourceImpl.readRespiratoryRate(interval)
    }
